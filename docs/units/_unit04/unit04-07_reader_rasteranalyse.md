...
panel1:  
  - url: assets/images/unit04/keyboardnumbers.gif
    image_path: assets/images/unit04/keyboardnumbers.gif
...
panel2:  
  - url: assets/images/unit04/D8Algorithm.jpg
    image_path: assets/images/unit04/D8Algorithm.jpg
    title: "D8 Formel"
    alt: "D8 Formel"

panel3:  
  - url: assets/images/unit04/Upstream_Formula.gif
    image_path: assets/images/unit04/Upstream_Formula.gif
    title: "Oberlieger  Formel"
    alt: "Oberlieger Formel"

panel4:  
  - url: assets/images/unit04/Wetness_Formula.gif
    image_path: assets/images/unit04/Wetness_Formula.gif
    title: "Wetness  Formel"
    alt: "Wetness Formel"

panel5:  
  - url: assets/images/unit04/StreamPower_Formula.gif
    image_path: assets/images/unit04/StreamPower_Formula.gif
    title: "Stream Power Formel"
    alt: "Stream Power Formel"

panel6:  
  - url: assets/images/unit04/Sediment_Formula.gif
    image_path: assets/images/unit04/Sediment_Formula.gif
...
{% include figure image_path="assets/images/unit04/ldd_clarify.gif" alt="LDD-Netz für ein kleines DGM (links) Lokale Abflussrichtungen sind als Pfeile gekennzeichnet, (Rechts) Lokale Abflussrichtungen nach dem Zeichenblock einer Tastatur gekennzeichnet" caption="*LDD-Netz für ein kleines DGM (links) Lokale Abflussrichtungen sind als Pfeile gekennzeichnet, (rechts) Lokale Abflussrichtungen nach dem Zeichenblock einer Tastatur gekennzeichnet*" %}
...
{% include figure image_path="assets/images/unit04/flowDirection_look.gif" alt="Abflussrichtungen, die von einem 25m-Raster-DGM mit einem D8-Algorithmus errechnet wurden. (Swisstopo 1991)" caption="*Abflussrichtungen, die von einem 25m-Raster-DGM mit einem D8-Algorithmus errechnet wurden. (Swisstopo 1991)*" %}


Analog dazu kann ein ldd net in einen Vektordatensatz transformiert und entsprechend visualisiert werden.


{% include figure image_path="assets/images/unit04/lddnetLook.gif" alt="Ein LDD-Netz als Vektorkarte" caption="*Ein LDD-Netz als Vektorkarte*" %}
...
{% include figure image_path="assets/images/unit04/flowaccumulation2_clarify.gif" alt="Berechnung der Anzahl von flussaufwärtsliegenden Elementen für jedes Pixel." caption="*Berechnung der Anzahl von flussaufwärtsliegenden Elementen für jedes Pixel.*" %}
...
{% include figure image_path="assets/images/unit04/upstreamElements.gif" alt="Wasseransammlungen können anhand eines ldd nets errechnet werden. (Swisstopo 1991)" caption="*Wasseransammlungen können anhand eines ldd nets errechnet werden. (Swisstopo 1991)*" %}
...
{% include figure image_path="assets/images/unit04/wetnessIndex.gif" alt="Der aus dem ldd net abgeleitete Feuchtigkeitsindex. (Swisstopo 1991)" caption="*Der aus dem ldd net abgeleitete Feuchtigkeitsindex. (Swisstopo 1991)*" %}
...
{% include figure image_path="assets/images/unit04/streamPowerIndex.gif" alt="Das vom ldd net abgeleitete Flussintensitätsindex. (Swisstopo 1991)" caption="*Der vom ldd net abgeleitete Flussintensitätsindex. (Swisstopo 1991)*" %}
...
{% include figure image_path="assets/images/unit04/sedimentTransportIndex.gif" alt="Der vom ldd net abgeleitet Sedimenttransportindex . (Swisstopo 1991)" caption="*Der vom ldd net abgeleitet Sedimenttransportindex . (Swisstopo 1991)*" %}
...
{% include figure image_path="assets/images/unit04/maximumFlowPathLength.gif" alt="Maximaler Fließweg in Meter zu jedem flussaufwärts vorhandenen Pixel. (Swisstopo 1991)" caption="*Maximaler Fließweg in Meter zu jedem flussaufwärts vorhandenen Pixel. (Swisstopo 1991)*" %}
