...
Öffnen Sie mit Google Earth die Datei die zuvor heruntergeladene Datei [Raster oder Vektor](https://github.com/gisma-courses/geoinfo-basis-qgis/blob/main/docs/assets/data/RasteroderVektormodell3D.kmz). Versuchen Sie zu identifizieren, welches Datenmodell für welche der dargestellten Information verwendet wird.
